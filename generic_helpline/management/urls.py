...
from .views import (Helplines, HelperProfile, getHelperCategoryandSubcategory, Languages, AllClients,
                    ...
                    CreateFollowUpTask, CreateSurveyFollowUpTask, AvailableSlots, DoctorAvailableSlots, DoctorBookedSlots, newClientTasks, getTask)
...
urlpatterns = [
    ...
    url(r'^getTask/$', getTask.as_view(), name='getTask'),
]