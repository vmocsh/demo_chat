...
from .views import Home,Helper_Profile,Yearly_Stats,Task_Details,Update_Survey_Users,Survey_Users,Monthly_Stats,BulkHelperRegistration,DeleteHelper,QandA_Category, view_surveys, combined_csv, Create_Survey, Create_Tasks, Clientwise_Surveys, Client_Profile, download_csv, tag_list, DoctorSlots, AddTaskDashboard, FormOrChat
...
url(r'^add_task/', AddTaskDashboard, name='add_task'),
url(r'^form_or_chat/', FormOrChat, name='form_or_chat'),
]