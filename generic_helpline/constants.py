...
# URLs
BASE_URL = 'http://vmocsh.cse.iitb.ac.in/demo_chat/'
AUDIO_URL = 'http://vmocsh.cse.iitb.ac.in/demo_chat/media/'
LOGIN_URL = '/demo_chat/web_auth/login/'
STATIC_URL_APPEND = '/demo_chat'
URL_APPEND = 'demo_chat/'
HELPLINE_NAME = 'Demo Chat'
HELPLINE = "demo"
